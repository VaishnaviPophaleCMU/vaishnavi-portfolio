        ...
        <div className="about-page">
          ...
          >
            ...
            <div className="about-intro-text">
              ...
              <p>
                I&apos;m currently pursuing a Master of Computational Data
                Science at Carnegie Mellon University, School of Computer
                Science.
              </p>
  
              <p>
                My work sits at the intersection of software engineering,
                data systems, and AI. I&apos;m passionate about distilling
                complex challenges into production-grade machine learning
                solutions and building scalable ML and AI systems that turn
                large-scale data into reliable, intelligent products and
                workflows.
              </p>
  
              <p>
                Before CMU, I worked at MSCI on financial analytics and
                portfolio risk systems, building APIs, AI-powered tooling,
                and cloud configuration systems.
              </p>
            ...
            <div className="about-details">
              ...
              <div className="about-detail">
                ...
                <span>
                  Full Stack Development · Machine Learning Systems ·
                  Artificial Intelligence · Generative AI · Natural
                  Language Processing
                </span>
              </div>
            ...
            <div className="about-links">
              ...
              <a
                className="about-link"
                href="https://linkedin.com/in/vaishnavi-pophale"
                target="_blank"
                rel="noreferrer"
              >
                <Linkedin size={14} />
